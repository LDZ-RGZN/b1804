...
class BasePlane(Plane):
    def __init__(self,img_path,screen,x,y):
        ...
        #___________________________________________
        self.twobomb_list = [] #敌机爆炸
        self.__two_image()#添加图片
        self.image_two = 0
        self.image_indextwo = 0
        self.a = 1
    ...
    def __two_image(self):
        self.twobomb_list.append(pygame.image.load('./images/enemy1_down1.png'))
        self.twobomb_list.append(pygame.image.load('./images/enemy1_down2.png'))
        self.twobomb_list.append(pygame.image.load('./images/enemy1_down3.png'))
        self.twobomb_list.append(pygame.image.load('./images/enemy1_down4.png'))
        self.twobomb_list.append(pygame.image.load('./images/enemy1_down4.png'))
    def display(self):
        if self.hit == True:
            ...
            self.screen.blit(self.twobomb_list[self.image_indextwo],self.rect)
            self.image_two += 1
            if self.image_two == 7:
                self.image_indextwo += 1
                self.image_two = 0
            elif self.image_indextwo > 3:
                self.image_indextwo = 0
                self.rect = pygame.Rect(self.x-500,self.y,0,0)
                self.two = False
        else:
